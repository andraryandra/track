...
@section('admin')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary my-3" href="{{ route('dashboard.userPengguna.index') }}"> Kembali</a>
            </div>
        </div>
    </div>
    ...
    {!! Form::model($user, ['method' => 'PATCH', 'route' => ['dashboard.userPengguna.update', $user->id]]) !!}
    <div class="card">
        <div class="card-body">
