    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <h5 class="mb-0">Details Users Pengguna</h5>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                            <a href="{{ route('dashboard.userPengguna.show', $data_user->id) }}"
                                                class="text-primary mx-1" data-bs-toggle="tooltip"
                                                data-bs-placement="bottom" title="Lihat">
                                                <i class="bi bi-eye-fill"></i>
                                            </a>
                                            <a href="{{ route('dashboard.userPengguna.edit', $data_user->id) }}"
                                                class="text-warning mx-1" data-bs-toggle="tooltip"
                                                data-bs-placement="bottom" title="Edit">
                                                <i class="bi bi-pencil-fill"></i>
                                            </a>

                                            <a href="{{ route('dashboard.userPengguna.destroy', $data_user->id) }}"
                                            ...
                                            <form id="delete-form-{{ $data_user->id }}"
                                                action="{{ route('dashboard.userPengguna.destroy', $data_user->id) }}"
